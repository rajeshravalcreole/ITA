<?php
/**
 * Investors Trust: Color Patterns
 *
 * @package WordPress
 * @subpackage investorstrust
 * @since 1.0
 */
 ...
 */
function investorstrust_custom_colors_css() {
	...
	/**
	 * Filter Investors Trust default saturation level.
	 *
	 * @since Investors Trust 1.0
	 *
	 * @param int $saturation Color saturation level.
	 */
	$saturation = apply_filters( 'investorstrust_custom_colors_saturation', 100 );
	$saturation = absint( $saturation ) . '%';

	/**
	 * Filter Investors Trust default selection saturation level.
	 *
	 * @since Investors Trust 1.0
	 *
	 * @param int $saturation_selection Selection color saturation level.
	 */
	$saturation_selection = absint( apply_filters( 'investorstrust_custom_colors_saturation_selection', 50 ) );
	$saturation_selection = $saturation_selection . '%';

	/**
	 * Filter Investors Trust default lightness level.
	 *
	 * @since Investors Trust 1.0
	 *
	 * @param int $lightness Color lightness level.
	 */
	$lightness = apply_filters( 'investorstrust_custom_colors_lightness', 33 );
	$lightness = absint( $lightness ) . '%';

	/**
	 * Filter Investors Trust default hover lightness level.
	 *
	 * @since Investors Trust 1.0
	 *
	 * @param int $lightness_hover Hover color lightness level.
	 */
	$lightness_hover = apply_filters( 'investorstrust_custom_colors_lightness_hover', 23 );
	$lightness_hover = absint( $lightness_hover ) . '%';

	/**
	 * Filter Investors Trust default selection lightness level.
	 *
	 * @since Investors Trust 1.0
	 *
	 * @param int $lightness_selection Selection color lightness level.
	 */
	$lightness_selection = apply_filters( 'investorstrust_custom_colors_lightness_selection', 90 );
	...
	/**
	 * Filters Investors Trust custom colors CSS.
	 *
	 * @since Investors Trust 1.0
	 *
	 ...
	 */
	return apply_filters( 'investorstrust_custom_colors_css', $theme_css, $primary_color, $saturation );
}
