...
function getRetirementSummaryPdf( $request_data ) {
    ...
    $chk_table_rows = $age_difference+20;
	...
	if ( $language == 'en' ) {
        ...
        $disclosures_description        = chunk_split_unicode($disclosures_description, 85, "<br/>");
        $retirement_goal_of_report_text = chunk_split_unicode($retirement_goal_of_report_text, 45, "<br/>");
        $retirement_expenses_text       = chunk_split_unicode($retirement_expenses_text, 20, "<br/>");
        $saving_amount_text             = chunk_split_unicode($saving_amount_text, 20, "<br />");
   ...
   $disclosures_description = str_replace("\\n","<br>",$disclosures_description);
	...
	$pdf_html.='<page  backtop="14mm" backbottom="14mm" backleft="10mm" backright="10mm">
    <page_header>
                ...
                <table style="background: #fff; width:100%;">
                    ...
                    <tr>
                        <td style="width:100%; padding: 8px;">
                            <table style="width:100%;" class="table-after-graph" cellspacing="0">
                                <tr>
                                      <th style="font-size: 12px; font-weight: 400; border-right:2px solid #fff; background-color: #317996; color:white; padding: 9px 9px; text-align: center;"  >'.strtoupper($year_text).'</th>
                                      <th style="font-size: 12px; font-weight: 400; border-right:2px solid #fff; background-color: #265F7D; color:white; padding: 9px 9px; text-align: center;" >'.strtoupper($age_text).'</th>
                                      <th style="font-size: 12px; font-weight: 400; border-right:2px solid #fff; background-color: #9FB4C0; color:white; padding: 9px 9px; text-align: center;" >'.strtoupper($saving_text).'</th>
                                      <th style="font-size: 12px; font-weight: 400; background-color: #5E6771; color:white; padding: 9px 9px; text-align: center;" >'.strtoupper($expenses_text).'</th>
                                </tr>';
								...
								for ($year=0; $year < 18; $year++) {
									...
									$pdf_html.= '<tr class="'.$odd_row_class.'">
													<td  style="color: rgb(37, 37, 37);font-size: 9px;padding:2px; width: 15%; margin:0px; text-align: center;" >'.$year.'</td>
													<td  style="color: rgb(37, 37, 37);font-size: 9px;padding:2px; width: 15%; margin:0px; text-align: center;" >'.$table_data['age'][$year].'</td>
													<td style="color:'.$text_color.';font-size: 9px; padding:2px; width: 35%; text-align: center;" >'.$currency_symbol.' '.$table_data_savings[$year].'</td>
													<td style="color: rgb(37, 37, 37);font-size: 9px; padding:2px; width: 35%; text-align: center;" >'.$currency_symbol.' '.$table_data_expenses[$year].'</td>
												</tr>';
									$chk_even_odd_row++;
								}
...
<table style="width:100%; background:#f4f5f6;">
    <tr>
        ...
        <tr>
        <td style="width:100%; padding: 8px;">
            <table style="width:100%;" class="second-table-main" cellspacing="0">   
                <tr>
                  <th style="font-size: 12px; font-weight: 400; border-right:2px solid #fff; background-color: #317996; color:white; padding: 8px 9px; text-align: center;"  >'.strtoupper($year_text).'</th>
                  <th style="font-size: 12px; font-weight: 400; border-right:2px solid #fff; background-color: #265F7D; color:white; padding: 8px 9px; text-align: center;" >'.strtoupper($age_text).'</th>
                  <th style="font-size: 12px; font-weight: 400; border-right:2px solid #fff; background-color: #9FB4C0; color:white; padding: 8px 9px; text-align: center;" >'.strtoupper($saving_text).'</th>
       ...
       if($chk_table_rows >=63){
           $pdf_html.='</page><page  backtop="14mm" backbottom="14mm" backleft="10mm" backright="10mm" style="font-size: 12pt">
           <page_header>
               <table style="padding: 10px 30px; width: 100%; display: inline-block;" >
                       <tr>
                           <td style="width: 100%; display: inline-block;">
           ...
           <div style="for-blank-space"></div>';   
           $age_limit = $desired_age + 20 - $current_age;
           if($age_limit > 73){
            // third table if data goes more 
            $pdf_html.='<div style="for-blank-space"></div><table style="width:100%; background:#f4f5f6;">
        <tr>
        <td style="padding: 8px; width:100%;">
        <table class="fourth-section-main">
        <tr>
        ...
        <td style="width:100%; padding: 8px;">
            <table style="width:100%;" class="second-table-main" cellspacing="0">   
               ...
               $chk_even_odd_row = 0;
                    for ($year=73; $year < $age_limit; $year++) { 
        ...
        // End third table if data goes more 
       }                  
    $pdf_html.= '<table style="width:100%; background: #0D212F; margin-top:15px;">
    <tr>
    ...
    if($chk_table_rows < 63 && $chk_table_rows >=56){
        $pdf_html.='</page><page  backtop="14mm" backbottom="14mm" backleft="10mm" backright="10mm" style="font-size: 12pt">
           <page_header>
               <table style="padding: 10px 30px; width: 100%; display: inline-block;" >
                       <tr>
...
try {
    ...
    // check languages for assign font family 
   ...
   // check languages for replace character in center  
   if($language == 'zh-hant'){
    ...
    $pdf_html = $pdf_html.$disclosure_html;  //Combine html for generate pdf
