<link rel="stylesheet" type="text/css" href="/var/www/html/ita-web/wp-content/themes/investorstrust/html2pdf/html_template/style_en_pdf.css">
                ...
                <tr>
                    <td style="width: 100%; display: inline-block;">
                        <table class="header-main-outer" style="display: inline-block; width: 100%;">
                                <tr>
                                    <td style="width: 50%;">
                                        <span class="first-title">RETIREMENT</span><br>
                                        <span class="second-title">CALCULATOR REPORT</span>
                                    </td>
        ...
        <tr>
            <td  style="width: 100%; display: inline-block;">
                <div class="second-section" style="display: inline-block;width: 100%">
                    <p class="first-text">Find out if you’re on track for retirement</p>
                    <p class="second-text">The goal of this report is to help you determine the amount of money that you will need to save monthly to fund your retirement financial objectives. Time, your monthly savings amount and the estimated rate of return are very important factors in planning for your future.</p> 
                </div>
            </td>
        </tr>
    </table>
    ...
    <table class="third-section-main" style="width: 100%;">        
        <tr>
            <td style="padding: 5px 20px 5px 20px; width:100%;">
                ...
                <span style="margin-top:12px;">The following results are based on your inputs.</span>
            </td>            
        </tr>
        <tr>
                    ...
                    <tr>
                        <td style="padding: 0px; width:50%;">
                            <div class="first-box">
                                <div class="first-box-row">
                                    <p class="first-box-text">To meet your retirement goals, at the time of retirement you will need a savings of:</p>
                                    <p class="first-box-price"> $ 1, 460, 680 </p>   
                                    <hr>  
                                </div>

                                <div class="first-box-row">
                                    <p class="first-box-text">With the selected monthly contribution, your savings at retirement will be:</p>
                                    <p class="first-box-price"> $ 504, 109 </p>
                                    <hr>     
                                </div>

                                <div class="first-box-row">
                                    <p class="first-box-text">If you start saving now, to meet your  retirement goals, your monthly savings  should be:</p>
                        ...
                        <td style="padding: 0px; width:50%;">
                            <div class="second-box">
                                <p style='color: rgb(0, 176, 219); font-size: 8px; margin-top:12px; margin-bottom:0px;'> Your Retirement Plan Inputs 
                                </p> 
                                <hr>
                                <table style="width:100%">
                                    <tr>
                                        <td style="font-size: 8px; width:70%">Currency</td>
                                        <td style="font-size: 8px; width:30%;">eur</td>
                                    </tr>

                                    <tr>
                                        <td style="font-size: 8px; width:70%">Current age</td>
                                        <td style="font-size: 8px; width:30%;">35</td>
                                    </tr>

                                    <tr>
                                        <td style="font-size: 8px; width:70%">Desired retirement age</td>
                                        <td style="font-size: 8px; width:30%;">65</td>
                                    </tr>

                                    <tr>
                                        <td style="font-size: 8px; width:70%">Current retirement savings</td>
                                        <td style="font-size: 8px; width:30%;">eur 60, 000</td>
                                    </tr>

                                    <tr>
                                        <td style="font-size: 8px; width:70%"> Monthly contribution</td>
                                        <td style="font-size: 8px; width:30%;">eur 800</td>
                                    </tr>

                                    <tr>
                                        <td style="font-size: 8px; width:70%">First year of retirement expenses</td>
                                        <td style="font-size: 8px; width:30%;">eur 80, 000 </td>
                                    </tr>

                                    <tr>
                                        <td style="font-size: 8px; width:70%"> Expected annual inflation rate</td>
                                        <td style="font-size: 8px; width:30%;">6.00%</td>
                                    </tr>
                                    <tr>
                                        <td style="font-size: 8px; width:70%">Pre-Retirement estimated annual Rate of Return</td>
                                        <td style="font-size: 8px; width:30%;">2.00%</td>
                                    </tr>
                                    <tr>
                                       <td style="font-size: 8px; width:70%">Post-Retirement estimated annual Rate of Return </td>
                ...
                <table style="background: #fff; width:100%;">
                    <tr>
                        <td style="padding: 8px; width:100%;">
                            <span>Retirement Savings Over Time</span>
                        </td>
                    </tr>
                    <tr>
                        <td style="width:100%;">
                            <div class='graph'>
                                <img style='width: 650px; height: 190px;' src='/var/www/html/ita-web/wp-content/themes/investorstrust/api/graph.png'>
                                <p style='font-size: 8px; text-align: center;'> age </p>
                            </div>
                        </td>
                    </tr> 
                    <tr>
                        <td style="width:100%; padding: 8px;">
                            <table style="width:100%;" class="table-after-graph">
                                <tr>
                                      <th style='font-size: 12px; font-weight: 400; background-color: #317996; color:white; padding: 8px 9px; text-align: center;'  >YEAR
                                      </th>
                                      <th style='font-size: 12px; font-weight: 400; background-color: #265F7D; color:white; padding: 8px 9px; text-align: center;' >AGE
                                      </th>
                                      <th style='font-size: 12px; font-weight: 400; background-color: #9FB4C0; color:white; padding: 8px 9px; text-align: center;' >SAVINGS
                                      </th>
                                      <th style='font-size: 12px; font-weight: 400; background-color: #5E6771; color:white; padding: 8px 9px; text-align: center;' >EXPENSES
                                      </th>
                                </tr>
                                <tr>
...
<table style="width:100%; background:#f4f5f6;">
    <tr>
        ...
        <td style="width:100%; padding: 8px;">
            <table style="width:100%;" class="second-table-main">   
                <tr>
                  <th style='font-size: 12px; font-weight: 400; background-color: #317996; color:white; padding: 8px 9px; text-align: center;'  >YEAR</th>
                  <th style='font-size: 12px; font-weight: 400; background-color: #265F7D; color:white; padding: 8px 9px; text-align: center;' >AGE</th>
                  <th style='font-size: 12px; font-weight: 400; background-color: #9FB4C0; color:white; padding: 8px 9px; text-align: center;' >SAVINGS</th>
                  <th style='font-size: 12px; font-weight: 400; background-color: #5E6771; color:white; padding: 8px 9px; text-align: center;' >EXPENSES</th>
               </tr>
               <tr>
    ...
    <tr>
        ...
        <td style="padding: 0px 0px 0px 45px; width:38%;">
            <p style='color: white;font-size: 15px; font-weight: 400; margin:0px 0px 20px 0px;'>Start Planning Today</p>
           <p style='color: white;font-size: 15px; font-weight: 400; margin:0px;line-height: 20px;'>If you're interested in saving for your retirement, find out more about Investors Trust’s Regular Savings Plan by visiting www.investors-trust.com.
           </p>
        </td>
    ...
    <div class='Important_Disclosures'>
      <p class="Important_Disclosures_Title">Important Disclosures</p>
      <p class="Important_Disclosures_Text">The interactive calculator being made available to you should be used as an educational tool for your independent use and is not intended to provide or represent financial or investment advice, nor should the interactive calculator be used as a substitute for professional advice. The interactive calculator above provides hypothetical information solely for illustrative purposes and does not represent the return on any particular investment nor should the interactive calculator be construed as guidance to the suitability of any investment. Anyone considering investing should seek professional advice. All investing involves risk, and the value of any investment cannot be predicted and will vary over time, therefore the value of the investment can fall as well as rise and there is the potential loss of principal. We cannot and do not guarantee the accuracy of the results or their applicability to your individual circumstances. Please note that past performance is not necessarily a guide to future performance, nor does it guarantee future results.</p>
   </div>    
</page>